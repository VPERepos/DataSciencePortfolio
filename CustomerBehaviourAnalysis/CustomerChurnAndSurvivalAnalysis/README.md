...
For Churn Probability estimation as the baseline estimator a simple **Logistic Regression** was trained and then compared with **Random Forest**, **XGBoost** and **LightGBM** classifiers. For survival analysis an implementation of the **Cox proportional hazards model** from **Scikit-survival** was used. The function for generating **Kaplan-Meier Curves** was implemented manually for estimating probability over time. The data were loaded and manipulated by **Pandas** and **NumPy**  libraries.